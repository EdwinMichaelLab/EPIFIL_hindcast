...
for iSites = 1:length(Sites)
    ...
    CfaData  = eval(sprintf('%sCfa',Sites{iSites}));
    ...
    RunSelectParameterVectors_wCFA(Sites{iSites},NParamVecs,MfData,CfaData,ABR,SIR_samples,...
        demoA1,demoB1,ageMax,bCulex,minPrev(iSites),maxPrev(iSites),ABRmax(iSites),ABRmin(iSites))
end
