...
for i = 1:NParamVecs
    ...
    [beta,alpha,k0,kLin,k1,r1,sigma1,psi1,psi2s2,mu,gamma,b1,c,ageLev,...
        k2,gam2,immC,slopeC,PP,alpha2,gamma2,del,k0_c,kLin_c] = ...
    ...
    cfaPrevArray(:,i) = mfAgeprevFun(cfaVec0,negBinshapeFun(cfaVec0,k0_c,kLin_c));  % size: ageMthMax x NParamVecs
